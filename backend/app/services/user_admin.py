...
from app.utils import send_approval_notification, send_rejection_notification
...
class UserAdminService:
    ...
    async def approve(self, user_id: int) -> UserResponse:
        ...
        send_approval_notification(user.email)
    ...
    async def reject(self, user_id: int) -> UserResponse:
        ...
        send_rejection_notification(user.email)
