...
import { ActiveGlobalFilter } from './NetworkGraph';
...
export default function ExportReportModal({
  ...
  const [reportTitle, setReportTitle] = useState('Scientific Co-Authorship & Network Analysis Summary');
  const [authorName, setAuthorName] = useState('Dr. Alena Vass (Lead Investigator)');
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      const canvas = await html2canvas(element, {
        ...
        onclone: (clonedDoc) => {
          // Create offscreen canvas context for color parsing
          ...
          // 1. Replace oklch in all <style> blocks
          ...
          // 2. Inline explicit RGB colors on cloned element tree
      ...
      pdf.save(`Scientific_Network_Report_${reportId}.pdf`);
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl max-w-4xl w-full max-h-[90vh] flex flex-col shadow-2xl overflow-hidden my-auto">
        ...
        <div className="p-4 border-b border-zinc-800 flex items-center justify-between bg-zinc-950">
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              <h2 className="text-sm font-bold text-zinc-100">Export Scientific Network Summary PDF</h2>
          ...
          >
            ...
            <div className="border-b border-zinc-800 pb-6 flex items-start justify-between gap-4">
              <div>
                <div className="flex items-center space-x-2 text-indigo-400 font-mono text-xs font-bold uppercase tracking-wider mb-1">
                  ...
                  <span>Scientific Network Analytics Platform</span>
                </div>
            ...
            <div className="pt-4 border-t border-zinc-800 text-[10px] font-mono text-zinc-500 flex items-center justify-between">
              <span className="flex items-center space-x-1">
                ...
                <span>Generated by FastAPI Scientific Collaboration Suite • PyJWT Authenticated Session</span>
              </span>
